package com.jy.coronaline.constant;
...
public enum ErrorCode {
    ...
    public String getMessage(Exception e) { // 예외를 받아 보내줌
        return getMessage(e.getMessage());
    }

    public String getMessage(String message) { // 사용자가 메세지를 입력한 경우
        return Optional.ofNullable(message)
                .filter(Predicate.not(String::isBlank)) //java11문법
                .orElse(getMessage());
    }
